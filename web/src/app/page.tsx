      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-primary-50 via-white to-white">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:py-32">
          <div className="text-center max-w-3xl mx-auto">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary-200 bg-primary-50 px-4 py-1 text-sm text-primary-700">
              <Sparkles className="h-4 w-4" />
              未来社区平台 — Polis 已上线
            </div>
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-6xl">
              让创建社区像
              <span className="text-primary-600">创建 GitHub 仓库</span>
              一样简单
            </h1>
        ...
        <div className="mx-auto max-w-7xl px-4 pb-20">
          <div className="grid gap-6 sm:grid-cols-3">
            <div className="card text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">零运维成本，像创建仓库一样创建你的社区</p>
            </div>
            <div className="card text-center">
              ...
              <h3 className="font-semibold">模块化</h3>
              <p className="mt-1 text-sm text-gray-500">论坛、视频、商城、代码仓库，按需启用</p>
            </div>
            <div className="card text-center">
              ...
              <h3 className="font-semibold">数据主权</h3>
              <p className="mt-1 text-sm text-gray-500">数据完全归你，支持随时 Markdown 导出</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="flex gap-6">
        ...
        <main className="flex-1 min-w-0 max-w-3xl">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-gray-500">发现你感兴趣的社区</p>
          </div>
          ...
          <div className="sticky top-20 space-y-4">
            <div className="card">
              ...
              <div className="space-y-2">
                <Link href="/create" className="block rounded-lg bg-primary-50 px-3 py-2 text-sm text-primary-700 hover:bg-primary-100 transition-colors">
                  ✨ 创建社区
                </Link>
                <Link href="/explore" className="block rounded-lg bg-gray-50 px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors">
                  🔍 探索社区
                </Link>
                <Link href="/search" className="block rounded-lg bg-gray-50 px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors">
                  🔎 搜索内容
                </Link>
              </div>
            </div>
